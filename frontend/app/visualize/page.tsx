...
const ALGORITHMS = [
  ...
  { slug: "binary-search", name: "二分查找 (Binary Search)", desc: "在有序数组中高效查找目标元素", icon: Binary },
  { slug: "bfs", name: "广度优先搜索 (BFS)", desc: "图的层序遍历 -- 最短路径基础算法", icon: GitBranch },
  { slug: "dp-table", name: "动态规划 (DP Table)", desc: "状态转移表的逐步推演过程", icon: Table2 },
];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {ALGORITHMS.map((algo) => (
          <Link key={algo.slug} href={`/visualize/${algo.slug}`}>
