...
# Keep ProblemBrief as alias for backward compatibility
ProblemBrief = ProblemOut
...
SolutionCreate = ProblemSolutionCreate
SolutionOut = ProblemSolutionOut
